...
const TIME_STEP = 20;
const DELTA_X = -2;
const MESSAGE = "I like 3.14 AKA PIE";
 ...
 */
   ...
   */
   function validateInput(characterSize) {
      var OK = re.exec(characterSize.value);
      var out = document.querySelector('#out');
      if (!OK) {
         out.textContent = ' Pls select characters between 20 and 30';
      } else {
